...
class AxeHelper:
    ...
    def check_accessibility(self, page: Page, maximum_allowed_violations_by_impact: Dict[str, int] = None) -> None:
        ...
        violations_count = dict(
            Counter([violation["impact"] for violation in results.get("violations")])
        )
